...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white via-slate-50/70 to-medical-bg pt-12 pb-20 sm:pt-20 sm:pb-32 lg:pt-24 lg:pb-36">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 sm:space-y-7 text-left">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-slate-500 leading-loose max-w-2xl font-normal">
              {siteConfig.hero.subheadline}
            </p>

            {/* Card de Identificação Médica Oficial (Obrigatório CFM 2.336/2023) */}
            <div className="bg-white/95 rounded-3xl p-5 sm:p-6 shadow-soft max-w-xl">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 pt-4 sm:pt-6 border-t border-slate-100 max-w-xl opacity-90">
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            ...
            <div className="relative w-full max-w-md">
              ...
              <div className="relative rounded-[2rem] overflow-hidden bg-white shadow-card">
                ...
                <div className="relative aspect-[4/5] bg-slate-100 overflow-hidden flex items-center justify-center">
                  ...
                  <div className="absolute top-5 left-5 right-5 flex justify-between items-center text-xs font-semibold bg-white/80 backdrop-blur-xl px-4 py-2 rounded-2xl shadow-sm">
                  ...
                  <div className="absolute bottom-5 left-5 right-5 bg-white/90 backdrop-blur-xl rounded-2xl p-4 shadow-card flex items-center justify-between gap-3">
